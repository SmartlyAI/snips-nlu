...
class XGBoostIntentClassifierConfig(FromDict, ProcessingUnitConfig):
    """Configuration of a :class:`.LogRegIntentClassifier`"""

    # pylint: disable=line-too-long
    def __init__(self, data_augmentation_config=None, featurizer_config=None, noise_reweight_factor=1.0):
        """
        Args:
            data_augmentation_config (:class:`IntentClassifierDataAugmentationConfig`):
                    Defines the strategy of the underlying data augmentation
    ...
    def data_augmentation_config(self, value):
        ...
        if isinstance(value, dict):
            self._data_augmentation_config = IntentClassifierDataAugmentationConfig.from_dict(value)
    ...
    @property
    def unit_name(self):
        from snips_nlu.intent_classifier import XGBoostIntentClassifier
        return XGBoostIntentClassifier.unit_name
