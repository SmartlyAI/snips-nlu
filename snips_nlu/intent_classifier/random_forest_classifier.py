...
class RandForIntentClassifier(IntentClassifier):
    ...
    def __init__(self, config=None, **shared):
        ...
        :class:`.RandForIntentClassifierConfig`"""
        super(RandForIntentClassifier, self).__init__(config, **shared)
    ...
    @log_elapsed_time(logger, logging.INFO,"RandForIntentClassifier in {elapsed_time}")
    def fit(self, dataset):
        """Fits the intent classifier with a valid Snips dataset

        Returns:
            :class:`RandForIntentClassifier`: The same instance, trained
        """
        from sklearn.ensemble import RandomForestClassifier
        from sklearn.utils import compute_class_weight
        
        logger.info("Fitting RandForIntentClassifier...")
